                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <select name="age">
                                                    ...
                                                    <option value="1"
                                                        @if ($contact->age === 1) selected @endif>〜１９歳</option>
                                                    <option value="2"
                                                        @if ($contact->age === 2) selected @endif>２０歳〜２９歳
                                                    </option>
                                                    <option value="3"
                                                        @if ($contact->age === 3) selected @endif>３０歳〜３９歳
                                                    </option>
                                                    <option value="4"
                                                        @if ($contact->age === 4) selected @endif>４０歳〜４９歳
                                                    </option>
                                                    <option value="5"
                                                        @if ($contact->age === 5) selected @endif>５０歳〜５９歳
                                                    </option>
                                                    <option value="6"
                                                        @if ($contact->age === 6) selected @endif>６０歳〜</option>
                                                </select>
                                            </div>
                                        </div>
