            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="get" action="{{ route('contacts.index') }}">
                        ...
                        <button
                        class="mb-8 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">検索する</button>
                    </form>
                            ...
                            <tbody>
                                @foreach ($contacts as $contact)
                                    <tr>
                                        ...
                                        <td class="border-t-2 border-gray-200 px-4 py-3 text-lg"><a
                                                class="text-blue-500"
